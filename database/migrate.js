...
async function migrate() {
  console.log("🚀 NutriGenius - Migrazione database...\n");
  ...
  if (count.rows[0].c === 0) {
    const foods = [
      [1,"Petto di pollo",165,31,0,3.6,"Carne",8.5,"kg"],[2,"Riso integrale",362,7.5,76,2.7,"Cereali",2.5,"kg"],
      [3,"Broccoli",34,2.8,7,0.4,"Verdura",2.0,"kg"],[4,"Salmone",208,20,0,13,"Pesce",18,"kg"],
      [5,"Uova (1 unità)",78,6,0.6,5,"Proteine",0.3,"pz"],[6,"Avocado",160,2,9,15,"Frutta",1.5,"pz"],
      [7,"Pane integrale",247,13,41,3.4,"Cereali",2.8,"kg"],[8,"Yogurt greco",59,10,3.6,0.4,"Latticini",1.2,"pz"],
      [9,"Banana",89,1.1,23,0.3,"Frutta",1.5,"kg"],[10,"Spinaci",23,2.9,3.6,0.4,"Verdura",3.0,"kg"],
      [11,"Pasta integrale",348,14,64,2.5,"Cereali",1.8,"kg"],[12,"Tonno in scatola",116,26,0,1,"Pesce",2.5,"pz"],
      [13,"Mozzarella",280,22,2.2,17,"Latticini",1.5,"pz"],[14,"Pomodori",18,0.9,3.9,0.2,"Verdura",2.5,"kg"],
      [15,"Mandorle",579,21,22,50,"Frutta secca",12,"kg"],[16,"Lenticchie",352,25,60,1,"Legumi",3.0,"kg"],
      [17,"Patate dolci",86,1.6,20,0.1,"Verdura",2.5,"kg"],[18,"Olio d'oliva (cucchiaio)",119,0,0,14,"Condimenti",8,"L"],
      [19,"Parmigiano (30g)",110,10,0,7.5,"Latticini",18,"kg"],[20,"Quinoa",368,14,64,6,"Cereali",6,"kg"],
      [21,"Ceci",364,19,61,6,"Legumi",2.5,"kg"],[22,"Zucchine",17,1.2,3.1,0.3,"Verdura",2.0,"kg"],
      [23,"Mela",52,0.3,14,0.2,"Frutta",2.5,"kg"],[24,"Tacchino",135,30,0,1,"Carne",9,"kg"],
    ...
    console.log(`  ⏭️  Già presenti`);
  }

  await db.execute("CREATE INDEX IF NOT EXISTS idx_diary_user ON diary_entries(user_id, entry_date)");
